...
export class Labels {
  ...
  constructor() {
    ...
    for (const def of LABELS) {
      ...
      div.style.cssText = 'color: rgba(255,255,255,0.5); font-size: 11px; font-family: "Cormorant Garamond", Georgia, serif; font-weight: 400; font-style: italic; text-shadow: 0 1px 6px rgba(0,0,0,0.35); pointer-events: none; white-space: nowrap; opacity: 0; transition: opacity 0.3s; letter-spacing: 3px; text-transform: uppercase;';
